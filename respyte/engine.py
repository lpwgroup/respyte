...
class EnginePsi4(Engine):
    ...
    def write_input(self, coordfile, basis='6-31g*', method = 'hf', charge = 0, solvent = None, filename = 'input.dat', job_path = None):
        ...
        with open(filename, 'w') as outfile:
            ...
            for idx, i in enumerate(molecule.elem):
                ...
                outfile.write('\n')
            if solvent is None:
                outfile.write(psi4_template_tail_gas.format(basis = basis, method =method)) #### set inside input file
            else:
                outfile.write(psi4_template_tail_solv.format(basis = basis, method =method, solvent=solvent))
