    ...
    def write_mol2(self, atomname, resid, resname, elem, xyz, qpot, outfilenm = 'out.mol2'):
        ...
        with open(outfilenm, 'w') as f:
            ...
            for idx, i in enumerate(xyz):
                ...
                f.write(row_format % (idx+1, atomidx, round(i[0]*bohr2Ang,4),
                        round(i[1]*bohr2Ang,4), round(i[2]*bohr2Ang,4), atoms[idx],
